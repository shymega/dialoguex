defmodule DBStore.DB.Schemas.HeaderValue do
  ...
  def changeset(model, params \\ :empty) do
    ...
    |> unique_constraint(:header_value,
      message: "Duplicate value for table `header_value`. This is not a fatal error."
    )
    |> unique_constraint(:header_value_hash,
      message: "Duplicate hash for table `header_value`. This is not a fatal error."
    )
  end
end
